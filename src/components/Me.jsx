function Me() {
  return (
    <>
      ...
      <p>
        Je suis un guitariste depuis quelques annees deja, ma principale passion
        a vrai dire ! Je suis fan de Metallica, comme vous allez pouvoir le voir
        un peu plus tard avec mes projets.<br></br>A part ca j&apos;aime les
        manga les animes ainsi que les jeux videos.
      </p>
    </>
  );
}
